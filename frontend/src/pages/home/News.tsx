...
const news = [
  {
    ...
    image: "assets/news/news-1.png", // Path adjusted for public folder
  },
  {
    id: 2,
    ...
    image: "assets/news/news-2.png", // Path adjusted for public folder
  },
  {
    id: 3,
    ...
    image: "assets/news/news-3.png", // Path adjusted for public folder
  },
  {
    id: 4,
    ...
    image: "assets/news/news-4.png", // Path adjusted for public folder
  },
  {
    id: 5,
    ...
    <div className="py-16">
      ...
      <Swiper
        ...
        breakpoints={{
          ...
          1024: {
            slidesPerView: 3, // Show 3 items for larger screens
            spaceBetween: 50,
          },
        }}
          ...
          <SwiperSlide key={item.id}>
            <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-12">
              ...
              <div className="flex-shrink-0">
                <img
                  src={item.image} // Now referencing the image path from public
                  alt={item.title} // Add meaningful alt text
